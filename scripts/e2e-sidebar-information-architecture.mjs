...
assert(railOrder.join('|') === 'rail-history|rail-new-chat|rail-images|rail-files|rail-fullscreen|rail-settings|rail-help', 'collapsed rail order is 历史/新建/图片/文件/全屏/设置/帮助 (got ' + railOrder.join('|') + ')')
