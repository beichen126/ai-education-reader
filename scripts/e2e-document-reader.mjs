...
await page.locator('[data-testid="reader-ctx-start"]').fill('3')
await page.locator('[data-testid="reader-ctx-end"]').fill('5')
...
await page.keyboard.press('Escape')
await page.waitForTimeout(200)
assert(await page.locator('[data-testid="reader-ctx-menu"]').count() === 0, 'M: Escape closes the ctx menu first')
await page.locator('[data-testid="reader-close"]').click()
await page.waitForTimeout(300)
