...
documentUiActions.openReader('d1', 7)
assert(getDocumentUiState().view === 'reader' && (getDocumentUiState() as any).documentId === 'd1' && (getDocumentUiState() as any).pageNumber === 7, 'ui: openReader carries id and requested page')
