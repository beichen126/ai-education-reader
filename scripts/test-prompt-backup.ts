...
assert(built.version === 7 && built.prompts.length === 2 && built.promptPreferences.sortPreference === 'name-asc', 'new build emits V7 prompt data')
assert(!('apiKey' in built.settings), 'V7 backup excludes API key')
