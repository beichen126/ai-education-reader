...
assert(await page.locator('[data-testid="reader-related-conversations"]').count() === 0, 'B1: 关于此页 stays closed until the user asks for it')
...
assert((await page.locator('[data-testid="reader-related-item"]').count()) === 1, 'B1: document A page 3 shows one related message')
