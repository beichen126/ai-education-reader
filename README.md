...
AI Education Reader 是一个在浏览器里使用的学习工具：你把教材、论文或讲义放进来，直接向 AI 提问；需要确认答案时，可以回到原文的页码继续看，也可以把回答整理成笔记和题目。
...
1. 打开产品，第一屏就是 **AI 对话**；
2. 需要依据教材时，从“文件”里打开 PDF，选中当前页或章节，带回这次对话；
3. AI 回答后，点击来源回到原文，继续追问、做笔记或生成题目。
...
- 本产品适合边读边问：从教材里选一页或一章给 AI，看完回答还能回到那一页，继续追问、记笔记和复习。
